...
import { SLAComponent } from 'app/entities/sla/sla.component';
import { SLAService } from 'app/entities/sla/sla.service';
import { SLA } from 'app/shared/model/sla.model';

describe('Component Tests', () => {
  describe('SLA Management Component', () => {
    let comp: SLAComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sLAS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
